...
const contactInfo = [
  { icon: 'ri-map-pin-line', label: { en: 'Address', km: 'អាសយដ្ឋាន' }, value: 'Street 240, Daun Penh, Phnom Penh, Cambodia' },
  { icon: 'ri-mail-line', label: { en: 'Email', km: 'អ៊ីមែល' }, value: 'hello@ramagallery.com' },
  { icon: 'ri-phone-line', label: { en: 'Phone', km: 'ទូរស័ព្ទ' }, value: '+855 23 123 456' },
  { icon: 'ri-timer-flash-line', label: { en: 'Hours', km: 'ម៉ោងធ្វើការ' }, value: 'Mon–Fri 9am–6pm ICT' },
]
