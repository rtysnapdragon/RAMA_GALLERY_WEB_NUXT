    ...
    <section class="section">
      <div class="container">
        ...
        <div class="blogs-grid">
          ...
          >
            <div class="blog-img">
              <RAImage :src="blog.image" :aspect="i === 0 ? 'wide' : 'landscape'" :watermark="false" />
...
const filteredBlogs = computed(() =>
  activeCategory.value === 'All' ? blogs : blogs.filter(b => b.category === activeCategory.value)
)
